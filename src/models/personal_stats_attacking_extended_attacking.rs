...
pub struct PersonalStatsAttackingExtendedAttacking {
    ...
    pub killstreak: Option<Box<models::PersonalStatsOtherOtherActivityStreak>>,
...
impl PersonalStatsAttackingExtendedAttacking {
    pub fn new() -> PersonalStatsAttackingExtendedAttacking {
