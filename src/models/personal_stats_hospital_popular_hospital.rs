...
pub struct PersonalStatsHospitalPopularHospital {
    ...
    pub reviving: Option<Box<models::PersonalStatsHospitalPopularHospitalReviving>>,
}

impl PersonalStatsHospitalPopularHospital {
    pub fn new() -> PersonalStatsHospitalPopularHospital {
