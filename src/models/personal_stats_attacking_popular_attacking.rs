...
pub struct PersonalStatsAttackingPopularAttacking {
    #[serde(rename = "attacks", skip_serializing_if = "Option::is_none")]
    pub attacks: Option<Box<models::PersonalStatsAttackingPopularAttackingAttacks>>,
    #[serde(rename = "defends", skip_serializing_if = "Option::is_none")]
    pub defends: Option<Box<models::PersonalStatsAttackingPopularAttackingDefends>>,
    ...
    pub faction: Option<Box<models::PersonalStatsAttackingPopularAttackingFaction>>,
}

impl PersonalStatsAttackingPopularAttacking {
    pub fn new() -> PersonalStatsAttackingPopularAttacking {
