...
pub struct UserPersonalStatsFullPersonalstats {
    #[serde(rename = "attacking", skip_serializing_if = "Option::is_none")]
    pub attacking: Option<Box<models::PersonalStatsAttackingExtendedAttacking>>,
    #[serde(rename = "battle_stats", skip_serializing_if = "Option::is_none")]
    pub battle_stats: Option<Box<models::PersonalStatsBattleStatsBattleStats>>,
    #[serde(rename = "jobs", skip_serializing_if = "Option::is_none")]
    pub jobs: Option<Box<models::PersonalStatsJobsExtendedJobs>>,
    ...
    pub networth: Option<Box<models::PersonalStatsNetworthExtendedNetworth>>,
    #[serde(rename = "other", skip_serializing_if = "Option::is_none")]
    pub other: Option<Box<models::PersonalStatsOtherOther>>,
}

impl UserPersonalStatsFullPersonalstats {
    pub fn new() -> UserPersonalStatsFullPersonalstats {
