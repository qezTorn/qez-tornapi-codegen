...
pub struct PersonalStatsOtherPopularOther {
    ...
    pub refills: Option<Box<models::PersonalStatsOtherPopularOtherRefills>>,
...
impl PersonalStatsOtherPopularOther {
    pub fn new() -> PersonalStatsOtherPopularOther {
