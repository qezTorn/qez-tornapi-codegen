...
pub struct PersonalStatsHospitalPopularHospitalReviving {
...
impl PersonalStatsHospitalPopularHospitalReviving {
    pub fn new() -> PersonalStatsHospitalPopularHospitalReviving {
