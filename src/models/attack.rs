...
pub struct Attack {
    ...
    pub attacker: Option<Box<models::AttackAttacker>>,
    #[serde(rename = "defender", skip_serializing_if = "Option::is_none")]
    pub defender: Option<Box<models::AttackPlayer>>,
    ...
    #[serde(rename = "is_interrupted", skip_serializing_if = "Option::is_none")]
    pub is_interrupted: Option<bool>,
    #[serde(rename = "is_stealthed", skip_serializing_if = "Option::is_none")]
    pub is_stealthed: Option<bool>,
    #[serde(rename = "is_raid", skip_serializing_if = "Option::is_none")]
    pub is_raid: Option<bool>,
    #[serde(rename = "is_ranked_war", skip_serializing_if = "Option::is_none")]
    pub is_ranked_war: Option<bool>,
    #[serde(rename = "modifiers", skip_serializing_if = "Option::is_none")]
    pub modifiers: Option<Box<models::AttackModifiers>>,
}
