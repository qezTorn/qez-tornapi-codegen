...
pub struct MarketGet200Response {
    #[serde(rename = "itemmarket", skip_serializing_if = "Option::is_none")]
    pub itemmarket: Option<Box<models::ItemMarket>>,
    ...
    pub selections: Option<Vec<models::MarketSelectionName>>,
    #[serde(rename = "timestamp", skip_serializing_if = "Option::is_none")]
    pub timestamp: Option<i32>,
}

impl MarketGet200Response {
    pub fn new() -> MarketGet200Response {
