...
pub struct PersonalStatsItemsPopularItems {
    #[serde(rename = "found", skip_serializing_if = "Option::is_none")]
    pub found: Option<Box<models::PersonalStatsItemsPopularItemsFound>>,
    #[serde(rename = "used", skip_serializing_if = "Option::is_none")]
    pub used: Option<Box<models::PersonalStatsItemsItemsUsed>>,
}

impl PersonalStatsItemsPopularItems {
    pub fn new() -> PersonalStatsItemsPopularItems {
